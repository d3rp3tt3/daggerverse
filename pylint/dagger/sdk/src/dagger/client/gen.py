...
class Container(Type):
    ...
    @typecheck
    def as_tarball(self, *, platform_variants: Sequence["Container"] | None = [], forced_compression: ImageLayerCompression | None = None, media_types: ImageMediaTypes | None = "OCIMediaTypes",) -> "File":
    ...
    async def env_variables(self) -> list["EnvVariable"]:
        ...
        _ctx = EnvVariable(_ctx)._select_multiple(_name="name", _value="value",)
    ...
    @typecheck
    async def export(self, path: str, *, platform_variants: Sequence["Container"] | None = [], forced_compression: ImageLayerCompression | None = None, media_types: ImageMediaTypes | None = "OCIMediaTypes",) -> bool:
    ...
    async def exposed_ports(self) -> list["Port"]:
        ...
        _ctx = Port(_ctx)._select_multiple(_description="description", _experimental_skip_healthcheck="experimentalSkipHealthcheck", _port="port", _protocol="protocol",)
    ...
    @typecheck
    def import_(self, source: "File", *, tag: str | None = "",) -> "Container":
    ...
    async def labels(self) -> list["Label"]:
        ...
        _ctx = Label(_ctx)._select_multiple(_name="name", _value="value",)
    ...
    @typecheck
    def pipeline(self, name: str, *, description: str | None = "", labels: Sequence[PipelineLabel] | None = [],) -> "Container":
    ...
    @typecheck
    async def publish(self, address: str, *, platform_variants: Sequence["Container"] | None = [], forced_compression: ImageLayerCompression | None = None, media_types: ImageMediaTypes | None = "OCIMediaTypes",) -> str:
    ...
    @typecheck
    def terminal(self, *, cmd: Sequence[str] | None = None,) -> "Terminal":
    ...
    @typecheck
    def with_directory(self, path: str, directory: "Directory", *, exclude: Sequence[str] | None = [], include: Sequence[str] | None = [], owner: str | None = "",) -> "Container":
    ...
    @typecheck
    def with_entrypoint(self, args: Sequence[str], *, keep_default_args: bool | None = False,) -> "Container":
    ...
    @typecheck
    def with_env_variable(self, name: str, value: str, *, expand: bool | None = False,) -> "Container":
    ...
    @typecheck
    def with_exec(self, args: Sequence[str], *, skip_entrypoint: bool | None = False, stdin: str | None = "", redirect_stdout: str | None = "", redirect_stderr: str | None = "", experimental_privileged_nesting: bool | None = False, insecure_root_capabilities: bool | None = False,) -> "Container":
    ...
    @typecheck
    def with_exposed_port(self, port: int, *, protocol: NetworkProtocol | None = "TCP", description: str | None = None, experimental_skip_healthcheck: bool | None = False,) -> "Container":
    ...
    @typecheck
    def with_file(self, path: str, source: "File", *, permissions: int | None = None, owner: str | None = "",) -> "Container":
    ...
    @typecheck
    def with_files(self, path: str, sources: Sequence["File"], *, permissions: int | None = None, owner: str | None = "",) -> "Container":
    ...
    @typecheck
    def with_mounted_cache(self, path: str, cache: CacheVolume, *, source: "Directory | None" = None, sharing: CacheSharingMode | None = "SHARED", owner: str | None = "",) -> "Container":
    ...
    @typecheck
    def with_mounted_directory(self, path: str, source: "Directory", *, owner: str | None = "",) -> "Container":
    ...
    @typecheck
    def with_mounted_file(self, path: str, source: "File", *, owner: str | None = "",) -> "Container":
    ...
    @typecheck
    def with_mounted_secret(self, path: str, source: "Secret", *, owner: str | None = "", mode: int | None = 256,) -> "Container":
    ...
    @typecheck
    def with_new_file(self, path: str, *, contents: str | None = "", permissions: int | None = 420, owner: str | None = "",) -> "Container":
    ...
    @typecheck
    def with_registry_auth(self, address: str, username: str, secret: "Secret",) -> "Container":
    ...
    @typecheck
    def with_unix_socket(self, path: str, source: "Socket", *, owner: str | None = "",) -> "Container":
    ...
    @typecheck
    def without_entrypoint(self, *, keep_default_args: bool | None = False,) -> "Container":
    ...
    @typecheck
    def without_exposed_port(self, port: int, *, protocol: NetworkProtocol | None = "TCP",) -> "Container":
...
class CurrentModule(Type):
    ...
    @typecheck
    def workdir(self, path: str, *, exclude: Sequence[str] | None = [], include: Sequence[str] | None = [],) -> "Directory":
...
class Directory(Type):
    ...
    @typecheck
    def docker_build(self, *, platform: Platform | None = None, dockerfile: str | None = "Dockerfile", target: str | None = "", build_args: Sequence[BuildArg] | None = [], secrets: Sequence["Secret"] | None = [],) -> Container:
    ...
    @typecheck
    def pipeline(self, name: str, *, description: str | None = "", labels: Sequence[PipelineLabel] | None = [],) -> "Directory":
        """Creates a named sub-pipeline.
    ...
    @typecheck
    def with_directory(self, path: str, directory: "Directory", *, exclude: Sequence[str] | None = [], include: Sequence[str] | None = [],) -> "Directory":
    ...
    @typecheck
    def with_file(self, path: str, source: "File", *, permissions: int | None = None,) -> "Directory":
    ...
    @typecheck
    def with_files(self, path: str, sources: Sequence["File"], *, permissions: int | None = None,) -> "Directory":
    ...
    @typecheck
    def with_new_directory(self, path: str, *, permissions: int | None = 420,) -> "Directory":
...
class Function(Type):
    ...
    async def args(self) -> list["FunctionArg"]:
        ...
        _ctx = FunctionArg(_ctx)._select_multiple(_default_value="defaultValue", _description="description", _name="name",)
    ...
    @typecheck
    def with_arg(self, name: str, type_def: "TypeDef", *, description: str | None = "", default_value: JSON | None = None,) -> "Function":
...
class FunctionArg(Type):
    ...
    __slots__ = ("_default_value", "_description", "_name",)
...
class FunctionCall(Type):
    ...
    async def input_args(self) -> list["FunctionCallArgValue"]:
        ...
        _ctx = FunctionCallArgValue(_ctx)._select_multiple(_name="name", _value="value",)
...
class InputTypeDef(Type):
    ...
    async def fields(self) -> list[FieldTypeDef]:
        ...
        _ctx = FieldTypeDef(_ctx)._select_multiple(_description="description", _name="name",)
...
class InterfaceTypeDef(Type):
    ...
    async def functions(self) -> list[Function]:
        ...
        _ctx = Function(_ctx)._select_multiple(_description="description", _name="name",)
...
class Module(Type):
    ...
    __slots__ = ("_description", "_name", "_sdk", "_serve",)
    ...
    async def dependencies(self) -> list["Module"]:
        ...
        _ctx = Module(_ctx)._select_multiple(_description="description", _name="name", _sdk="sdk", _serve="serve",)
    ...
    async def dependency_config(self) -> list["ModuleDependency"]:
        ...
        _ctx = ModuleDependency(_ctx)._select_multiple(_name="name",)
    ...
    async def interfaces(self) -> list["TypeDef"]:
        ...
        _ctx = TypeDef(_ctx)._select_multiple(_kind="kind", _optional="optional",)
...
class ModuleSource(Type):
    ...
    @typecheck
    def with_dependencies(self, dependencies: Sequence[ModuleDependency],) -> "ModuleSource":
...
class Port(Type):
    ...
    __slots__ = ("_description", "_experimental_skip_healthcheck", "_port", "_protocol",)
...
class Client(Root):
    ...
    @typecheck
    def pipeline(self, name: str, *, description: str | None = "", labels: Sequence[PipelineLabel] | None = None,) -> "Client":
        """Creates a named sub-pipeline.
...
class Service(Type):
    ...
    @typecheck
    async def up(self, *, ports: Sequence[PortForward] | None = [], random: bool | None = False,) -> Void | None:
...
class TypeDef(Type):
    ...
    @typecheck
    def with_field(self, name: str, type_def: "TypeDef", *, description: str | None = "",) -> "TypeDef":
    ...
    @typecheck
    def with_interface(self, name: str, *, description: str | None = "",) -> "TypeDef":
    ...
    @typecheck
    def with_object(self, name: str, *, description: str | None = "",) -> "TypeDef":

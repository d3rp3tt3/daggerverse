...
import (
	...
	"dagger/go-ci/internal/querybuilder"
)
...
func (r *Node) Publish(ctx context.Context, tokenSecret *Secret, version string, dryRun bool, opts ...NodePublishOpts) (string, error) {
